...
const CONDLABEL = {
  ...
  macd_golden_below0: 'MACD0선아래골든', mfi_oversold: 'MFI과매도', cci_oversold: 'CCI과매도', trend_filter: '추세필터', bullish_pattern: '강세캔들', pivot_support: '피봇지지', double_bottom: '쌍바닥', rsi_cross_up: 'RSI탈출', capitulation: '투매반등',
  rsi_overbought: 'RSI과매수', stoch_overbought: '스토캐과매수', macd_dead: 'MACD데드', bb_upper: '볼린저상단',
  mfi_overbought: 'MFI과매수', cci_overbought: 'CCI과매수', bearish_pattern: '약세캔들', pivot_resistance: '피봇저항', double_top: '쌍봉',
}
